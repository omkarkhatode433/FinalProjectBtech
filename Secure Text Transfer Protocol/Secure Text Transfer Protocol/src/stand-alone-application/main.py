...
'''
def openfileEnc():
	filename = tkFileDialog.askopenfilename(initialdir = "/home/omkar/Desktop",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/omkar/Desktop",title = "Select directory")
...
def opengithub(event):
	webbrowser.open_new(r"https://github.com/omkarkhatode433/LastDemo")

def openSairajlinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/sairaj-karche-75060271/")

def openSahillinkedin(event):
		webbrowser.open_new(r"https://www.linkedin.com/in/sahil-mhatre-1114b7205/")

def openOmkarlinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/omkar-khatode-561677260/")
'''
-----------------------------------------------------------------
UPDATE ENTRY LABELS
-----------------------------------------------------------------
...
def main():
	...
	Omkarsocial = Label(Aboutus, text="Omkar Khatode")
	Omkarsocial.bind("<Button-1>",openOmkarlinkedin)
	Omkarsocial.grid(row=5, sticky='SW',padx = 8)
	text3 = Label(Aboutus, text="|")
	text3.grid(row=5)
	sairajsocial = Label(Aboutus, text="Sairaj Karche")
	sairajsocial.bind("<Button-1>",openSairajlinkedin)
	sairajsocial.grid(row=5, sticky='SE',padx = 8)
	text3 = Label(Aboutus, text="|")
	text3.grid(row=5)
	sahilsocial = Label(Aboutus, text="sahil mhatre")
	sahilsocial.bind("<Button-1>", openSahillinkedin)
	sahilsocial.grid(row=5, sticky='SE', padx=8)
